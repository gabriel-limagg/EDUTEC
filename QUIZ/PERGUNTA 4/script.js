function verificarRespostas() {
  var respostasCorretas = ["E) Todas as alternativas anteriores."];
  var acertos = 0;
  var erros = 0;
  ...
  if (respostaSelecionada) {
      ...
      if (respostasCorretas.includes(resposta)) {
          ...
          var respostaCorretaElement = document.querySelector('input[value="E) Todas as alternativas anteriores."]').parentElement;
