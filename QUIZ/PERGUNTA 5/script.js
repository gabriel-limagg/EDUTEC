function verificarRespostas() {
  var respostasCorretas = ["C) Harmônicas e desarmônicas."];
  var acertos = 0;
  var erros = 0;
  ...
  if (respostaSelecionada) {
      ...
      if (respostasCorretas.includes(resposta)) {
          ...
          var respostaCorretaElement = document.querySelector('input[value="C) Harmônicas e desarmônicas."]').parentElement;
