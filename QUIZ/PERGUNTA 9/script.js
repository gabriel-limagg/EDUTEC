function verificarRespostas() {
  var respostasCorretas = ["E) Competição interespecífica."];
  var acertos = 0;
  var erros = 0;
  ...
  if (respostaSelecionada) {
      ...
      if (respostasCorretas.includes(resposta)) {
          ...
          var respostaCorretaElement = document.querySelector('input[value="E) Competição interespecífica."]').parentElement;
