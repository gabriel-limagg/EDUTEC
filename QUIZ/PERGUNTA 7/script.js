function verificarRespostas() {
  var respostasCorretas = ["B) Organismo de uma mesma espécie organizam-se de modo que todos os organismos trabalhem de maneira cooperativa."];
  var acertos = 0;
  var erros = 0;
  ...
  if (respostaSelecionada) {
      ...
      if (respostasCorretas.includes(resposta)) {
          ...
          var respostaCorretaElement = document.querySelector('input[value="B) Organismo de uma mesma espécie organizam-se de modo que todos os organismos trabalhem de maneira cooperativa."]').parentElement;
