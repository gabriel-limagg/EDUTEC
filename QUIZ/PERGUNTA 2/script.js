function verificarRespostas() {
  var respostasCorretas = ["A) Interespecífica e desarmônica."];
  var acertos = 0;
  var erros = 0;
  ...
  if (respostaSelecionada) {
      ...
      if (respostasCorretas.includes(resposta)) {
          ...
          var respostaCorretaElement = document.querySelector('input[value="A) Interespecífica e desarmônica."]').parentElement;
